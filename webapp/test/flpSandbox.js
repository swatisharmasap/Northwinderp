		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Northwind ERp",
									"targetURL": "#sapcomnorthwinderp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapcomnorthwinderp-display": {
								"semanticObject": "sapcomnorthwinderp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.com.northwinderp",
									"url": sap.ui.require.toUrl("sap/com/northwinderp")
								}
							}
						}
					}
